...
if(isset($_POST['submit_email'])){
        ...
        $to = "pradeep.kumar44@gmail.com";
        $subject = "Contact Us !!";
        $txt = $_POST['name'] .' '.  $_POST['email'].' '. $_POST['mgs'];
         $headers = "From: admin@classpath.io" . "\r\n" ;
        ...
        <div class="container">
            <div class="row contact-row">
                <div class="col-sm-8 margin-btm-30">
                    ...
                    <p>
                        We’d love to hear from you. Please fill in your details and your message. We will get back to you shortly.
                    </p>
                    ...
                    <form role="form" action="contact.php" method="post">
                        ...
                        <div class="form-group">
                            <label>Message</label>
                            <textarea class="form-control" placeholder="Enter your message here" rows="6" name="mgs"></textarea>
                        </div>
                        <div class="text-right">
                            <input type="submit" name='submit_email' class="btn btn-skin btn-lg" value="Submit Message">
                        </div>
                    </form>
                </div>
                <div class="col-sm-3 col-sm-offset-1">
                    ...
                    <ul class="list-inline contact-social">
                        <li><a href="https://www.facebook.com/classpath/"><i class="fa fa-facebook"></i></a></li>
