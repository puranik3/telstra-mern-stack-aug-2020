    ...
    <?php   
            ...
            if(isset($_POST['submit_email'])){
               $to = "pradeep.kumar44@gmail.com";
                $subject = "Register";
                $txt = $_POST['firstname'] .' '.  $_POST['lastname'].' '.  $_POST['phone'].' '.  $_POST['email'];
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 margin-btm-30">
                        <h2 style="text-transform: none;">Register</h2>
                    </div>
                ...
                <div class="col-md-7 margin-btm-40">
                    ...
                    <div class="row">
                       ...
                       <div class="pull-right">
                                 <a href="courses_java.php" class="btn btn-lg btn-border-skin">Register</a>
                        </div>
